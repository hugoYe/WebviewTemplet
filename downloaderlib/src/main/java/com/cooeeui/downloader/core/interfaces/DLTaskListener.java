...
public class DLTaskListener implements IDListener {
    ...
    /**
     * 下载开始时回调 暂未使用 Callback when download start. No use.
     *
    ...
    /**
     * 网络连接时回调 Callback when connect the network.
     *
    ...
    /**
     * 下载进行时回调 Callback when download in progress.
     *
    ...
    /**
     * 下载停止时回调 暂未使用 Callback when download stop. No use.
     */
    ...
    /**
     * 下载完成时回调 Callback when download finish.
     *
    ...
    /**
     * 下载出错时回调 Callback when download error.
     *
