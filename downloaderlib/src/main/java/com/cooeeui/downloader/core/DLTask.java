...
import static com.cooeeui.downloader.core.DLCons.Base.LENGTH_PER_THREAD;
import static com.cooeeui.downloader.core.DLCons.Base.MAX_REDIRECTS;
import static com.cooeeui.downloader.core.DLCons.Code.HTTP_MOVED_PERM;
import static com.cooeeui.downloader.core.DLCons.Code.HTTP_MOVED_TEMP;
import static com.cooeeui.downloader.core.DLCons.Code.HTTP_NOT_MODIFIED;
import static com.cooeeui.downloader.core.DLCons.Code.HTTP_OK;
import static com.cooeeui.downloader.core.DLCons.Code.HTTP_PARTIAL;
import static com.cooeeui.downloader.core.DLCons.Code.HTTP_SEE_OTHER;
import static com.cooeeui.downloader.core.DLCons.Code.HTTP_TEMP_REDIRECT;
import static com.cooeeui.downloader.core.DLError.ERROR_OPEN_CONNECT;
...
public class DLTask implements Runnable, IDLThreadListener {
    ...
    public DLTask(Context context, DLInfo info) {
        this.info = info;
